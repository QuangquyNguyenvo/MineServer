...
| **Warden (Boss Tối Thượng)** | **1500 HP** | **Thông báo Global & Nhạc Nền:** Báo chat toàn server khi thức tỉnh; tự động phát nhạc Boss (`custom.warden_theme`) lặp vô tận trong 40m.<br>**Phase 1 (> 30% HP / > 450 HP):** Kháng 30-50% vật lý, 80% Magic, miễn nhiễm ngạt nước, Anti-Flight (40m), Sculk Vacuum (kéo mục tiêu >16m), phá block 3x4x3, Sonic Boom gây 33% Max HP True Damage + giảm 50% hồi máu.<br>**Phase 2 (<= 30% HP / <= 450 HP):** Tăng **50% tốc độ**, Sonic Boom gây **45% Max HP**, **Kháng 100% sát thương tầm xa (cung, đinh ba, thuốc ném, đạn bắn...)** - buộc cận chiến.<br>**Huyết Tế Tối Thượng (< 10% HP / < 150 HP):** Gây **Nausea II, Blindness, Poison II trong 10s** (bán kính 40m), **Bất tử (miễn nhiễm 100% sát thương)**, **chuyển sang Nhạc Huyết Tế Cuồng Nộ (`custom.warden_sacrifice`)** và **hồi phục dần từ 150 HP lên 600 HP (40% Max HP) trong 10s**.<br>**Phần thưởng Hạ gục (Loot Drops):** 100% rơi **Lõi Nặng (Heavy Core)**, 1-2x Sao Địa Ngục, 1-2x Phôi Nâng Cấp Netherite, ~2000 XP; 10% rơi 1 Thần Khí (**Lưỡi Đao Hư Không - Lưỡi Hái Netherite Sharpness VII/Looting IV**, Giáp Ngực Protection VI hoặc Ủng Ghost Walker); 50% rơi 2-4 Táo Vàng Notch, 2 Thỏi Netherite, 2 Totem Bất Tử, 1 Bản mẫu Silence Trim. |
